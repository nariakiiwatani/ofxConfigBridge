...
public:
    ...
    virtual Result parseText(std::string_view text, Document& out, const Options& opt) = 0;
    virtual Result loadFile (const std::string& path, Document& out, const Options& opt) = 0;
